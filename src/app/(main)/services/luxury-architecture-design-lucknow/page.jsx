        ...
        <main className="min-h-screen bg-[#F4F1EC] text-gray-900">
            ...
            <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden pt-24 md:pt-28">
                ...
                <div className="relative z-10 text-center max-w-5xl px-6">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mb-8">
                        <span className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-4 py-1.5 rounded-full text-sm font-medium tracking-wide">✓ Bespoke Estates</span>
                        <span className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-4 py-1.5 rounded-full text-sm font-medium tracking-wide">✓ Global Sourcing</span>
            ...
            <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 p-4 z-50 shadow-[0_-10px_30px_rgba(0,0,0,0.08)] flex justify-between items-center sm:hidden pb-safe">
                <div className="flex flex-col">
                    ...
                    <span className="text-sm font-bold text-gray-900 leading-tight">Private Consultation</span>
                </div>
