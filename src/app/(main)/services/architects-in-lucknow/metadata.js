// app/services/architects-in-lucknow/metadata.js

export const metadata = {
  title: "Architects in Lucknow | Residential, Commercial & Turnkey Design",
  description:
    "Looking for architects in Lucknow? Explore residential, commercial and turnkey design services, project examples, LDA guidance and consultation options from Trygve Studio.",
  alternates: {
    canonical:
