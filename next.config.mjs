...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // ── Duplicate Canonical Fixes (found in GSC April 2026) ──────────────────
      // Legacy blog slug (2024 URL) → redirect to current URL
      {
        source: "/blogs/dream-home-blueprint-7-secrets-to-finding-the-best-residential-architects-in-lucknow-for-your-2024-build",
        destination: "/blogs/dream-home-blueprint-7-secrets-to-finding-the-best-residential-architects-in-lucknow-for-your-2026-build",
        statusCode: 301,
      },
    ];
  },
